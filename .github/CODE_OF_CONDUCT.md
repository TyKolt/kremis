...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact the maintainer at [https://github.com/TyKolt](https://github.com/TyKolt) via GitHub (open a private message or use [GitHub Private Security Advisories](https://github.com/TyKolt/kremis/security/advisories/new) for sensitive matters).
