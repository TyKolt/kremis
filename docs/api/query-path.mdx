...
Uses Dijkstra's algorithm with negative edge costs (`cost = -weight`) to prefer higher-weight paths, correctly prioritizing stronger multi-hop routes over weaker direct ones.
